...
j <- which(xFromCell(b2, 1:ncell(b2)) > -116.35 & b2[]> 30)
b2[j] <- NA
...
png( "C:/projects/phytolith/out/bilobate/fig/bilobate_predictions_unweighted.png", width = 7, height = 7, units = 'in', res = 150)
